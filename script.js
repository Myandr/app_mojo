...
document.addEventListener("DOMContentLoaded", () => {
      ...
      newsletterForm.addEventListener("submit", function (e) {
        ...
        if (email && isValidEmail(email)) {
          ...
          successMessage.innerHTML = `
                      ...
                      <p>Vielen Dank für Ihr Abonnement! Wir haben eine Bestätigungs-E-Mail an <strong>${email}</strong> gesendet.</p>
                  `
    ...
    if (playButton) {
      playButton.addEventListener("click", () => {
        ...
        alert("Video-Demo würde hier in der tatsächlichen Implementierung abgespielt werden.")
      })
    }
    ...
    const decorativeElements = document.querySelectorAll(".floating-dots, .floating-circles, .floating-waves")
    ...
    // Add random data-speed attributes to decorative elements
    decorativeElements.forEach((element) => {
      const randomSpeed = (Math.random() * 0.05 + 0.02).toFixed(2)
      element.setAttribute("data-speed", randomSpeed)
    })
  })
